...
------------ | ------------- | ------------- | -------------
**ship_to_service_point_id** | **string** | A unique identifier for a carrier service point where the shipment will be delivered by the carrier. This will take precedence over a shipment\&#39;s ship to address. | [optional] [default to undefined]
**ship_from_service_point_id** | **string** | A unique identifier for a carrier drop off point where a merchant plans to deliver packages. This will take precedence over a shipment\&#39;s ship from address. | [optional] [default to undefined]
...
```typescript
import { CreateLabelRequestBody } from 'shipstation-client';

const instance: CreateLabelRequestBody = {
